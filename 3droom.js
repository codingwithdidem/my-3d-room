  ...
  return (
    <group ref={group} {...props} dispose={null}>
      <group position={[24.66, 32.71, 30.26]} rotation={[1.18, 0.36, -0.71]}>
        <OrthographicCamera makeDefault={false} far={1000} near={0.1} rotation={[-Math.PI / 2, 0, 0]} />
      </group>
      ...
      />
      <group position={[-0.51, 13.45, 1.94]} rotation={[1.57, 0, -Math.PI]} scale={[-1.82, 1, 1]}>
      ...
      <mesh
        ...
        scale={3}
      />
      <mesh geometry={nodes.plane.geometry} material={materials.bg} position={[-0.54, 10.29, 5.27]} />
      <group position={[-0.53, 11.04, 3.79]}>
        <mesh geometry={nodes.Plane007.geometry} material={materials['Material.004']} />
        <mesh geometry={nodes.Plane007_1.geometry} material={materials['Material.003']} />
      </group>
    </group>
  )
}

useGLTF.preload('/3droom.gltf')
